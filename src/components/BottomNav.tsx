...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-black border-t border-violet-500/50 flex">
      <Link
        href="/matches"
        className={`flex-1 flex flex-col items-center py-2 gap-0.5 text-sm transition-colors ${
      ...
      <button
        ...
        className="flex-1 flex flex-col items-center py-2 gap-0.5 transition-colors text-violet-700 hover:text-violet-500 active:text-violet-400"
      >
